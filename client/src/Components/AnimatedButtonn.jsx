...
const AnimatedButton = ({ text = "Enroll Now" }) => {
    return (
        <button className="group relative inline-flex items-center gap-3 px-5 py-2 rounded-full font-medium bg-primary text-white overflow-hidden transition duration-300 hover:bg-gray-200 hover:text-dark">
